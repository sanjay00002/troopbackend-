                ...
                async (error, result) => {
                  if (error) {
                    ...
                    socket.on('send-stock-value',(stockFlow)=>{
                        if(isFetched === false && stockFlow.stock1[1] !== null && stockFlow.stock2[1] !== null){
                            console.log("stock value updated " + stockFlow.stock1 + " " + stock2);
                      ...
                      if (isEnd !== true) {
                        ...
                        pool.query(getQuery, [id], (error, result) => {
                          if (error) {
                            ...
                            matchedObject = result.rows[0];
                            if (matchedObject.selfSelectedStockId === stock1[0]) {
                        ...
                        pool.query(getWinnerQuery, [id], (error, result) => {
                          if (error) {
                            ...
                            const selfPerformance = (curr_match.selfStockCloseValue  - curr_match.selfStockOpenValue)/curr_match.selfStockOpenValue;
                            // console.log("Self Initialvalue: "+ curr_match.selfStockOpenValue +" Self CloseValue: " + curr_match.selfStockCloseValue);
                            const apponentPerformance = (curr_match.apponentStockCloseValue  - curr_match.apponentStockOpenValue)/curr_match.apponentStockOpenValue;
                            // console.log("appo Initialvalue: "+ curr_match.apponentStockOpenValue +" appo CloseValue: " + curr_match.apponentStockCloseValue);
                            
                            console.log("self: " + selfPerformance);
                            console.log("apponent: " + apponentPerformance);
                            if(selfPerformance > apponentPerformance){
                                const winner ="Self"
                                const setWinnerQuery = 'UPDATE public."MatchedLiveUsers" SET "winner" =$1  WHERE "id" = $2'
...
// {
//     id: 'N9CfmR1_K7',
//     selfId: 'Troop-9tHzWlUo',
//     apponentId: 'Troop-90Ey2SgS',
//     selfSelectedStockId: 2,
//     selfStockOpenValue: 1392380,
//     selfStockCloseValue: null,
//     apponnetSelectedStockId: 1,
//     apponentStockOpenValue: 1562525,
//     apponentStockCloseValue: null,
//     contestId: 'kJuFoQ8D8H',
//     winner: null,
//     createdAt: null,
//     updatedAt: null
//   }
